...
if __name__ == '__main__':
    ...
    #darknet detector valid data/chefCap.data cfg/chefCap.cfg weights/chefCap_diounms_mosaic_20000.weights
    #python reval_voc_py3.py --voc_dir data --classes data/chefCap.names results
