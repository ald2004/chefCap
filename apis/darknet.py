    ...
    for j in range(num):
        ...
        for i in range(meta.classes):
            ...
            if dets[j].prob[i] > 0:
                ...
                res.append((nameTag.decode('utf-8'), dets[j].prob[i], (b.x, b.y, b.w, b.h)))
...
def performDetect(imagePath="data/dog.jpg", thresh=0.25, configPath="./cfg/yolov4.cfg", weightPath="yolov4.weights",
...
def performBatchDetect(thresh=0.25, configPath="./cfg/yolov4.cfg", weightPath="yolov4.weights",
